...
public class JwtTokenUtils {
    ...
    private Key getSignInKey(){
        byte[] bytes = Decoders.BASE64.decode(secretKey);//Decoders.BASE64.decode("Rceldeq+VTnTXqF8NKTjpS+DfwDZ/SuPdZy1I+X0DEI=")
        //Keys.hmacShaKeyFor(Decoders.BASE64.decode("2jwNSeUM9oG7CohuToRlLnfgKoNIxpT2oFB0OEh66Xs="));
